...
import { addMember, getChatDetails, getMyChats, getMyGroups, leaveGroup, newGroupChat, removeMembers, sendAttachment } from '../controllers/chat.controller.js';
...
router.route('/:id').get(getChatDetails).put().post()
